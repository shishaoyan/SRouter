...
public class Postcard extends RouteMeta {
    ...
    public Object navigation(Context context, NavigationCallback callback) {
        return SRouter.getInstance().navigation(context, this, -1, callback);
    }
    ...
    public void navigation(Activity mContext, int requestCode, NavigationCallback callback) {
        SRouter.getInstance().navigation(mContext, this, requestCode, callback);
    }
...
//        serializationService = SRouter.getInstance().navigation(SerializationService.class);
