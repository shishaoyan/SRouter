package com.ssy.srouter.api.utils;
            ...
            DefaultPoolExecutor.getInstance().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Log.e("SRouter", "Scan map file in dex files made error.", ignore);
                    } finally {
                        if (null != dexfile) {
                            try {
                                dexfile.close();
...
//        if (SRouter.debuggable()) { // Search instant run support only debuggable
